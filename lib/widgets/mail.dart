          ...
          Column(
            ...
            Padding(
              ...
              child: Row( 
                ...
                children: <Widget>[
                  Container(width: mediaQueryData.size.width*.5,
                    child: Text('Full Name',style: TextStyle(fontWeight: FontWeight.bold),maxLines:1,overflow: TextOverflow.ellipsis,)),
                  Text('12:22 PM')//if today time if yesterday, yesterday, if before yesterday, date
                ],
              ),
            ),
            Row(
              ...
              children: <Widget>[
                Container( width: mediaQueryData.size.width*.5,
                  child: Text('the last Message message is too long for me to handle without spilling over the border', maxLines:1, overflow: TextOverflow.ellipsis,)),
                Icon(Icons.add), // icons shoould indicaat delivered and sent
                CircleAvatar(
                  radius: 13,
                  backgroundColor: Theme.of(context).accentColor,
                  child:FittedBox(child: Text('21'),),// number of unread messages
                )         
              ],
            ),
          ],)
